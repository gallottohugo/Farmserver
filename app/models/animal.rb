...
class Animal < ActiveRecord::Base
  ...
  attr_accessible :inactivated_at, :long_name, :id_fiscal, :breed, :weight, :origin, :birth_date_at, :state, :tambero_id, :comment_state, 
                  :rp_number, :male, :rp_sire, :rp_dam, :owner_id, :species_type, :life_production, :herd_id, :rfid_tag
